...
namespace BlazorQuizApi.Api.Migrations
{
    ...
    [Migration("20240622110409_MainQuiz")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blazor_Quiz_Class.Question", b =>
                {
                    ...
                    b.HasIndex("QuizMainId");

                    b.ToTable("Questions");
                });

            modelBuilder.Entity("Blazor_Quiz_Class.Quiz_Main", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Blazor_Quiz_Class.Question", b =>
                {
                    b.HasOne("Blazor_Quiz_Class.Quiz_Main", "QuizMain")
                        .WithMany("Questions")
                        .HasForeignKey("QuizMainId");

                    b.Navigation("QuizMain");
                });
